    ...
    const readinessFollowUp: FollowUpAction | null = useMemo(
        () =>
            buildFocusMonthFollowUp({
                ...
                recommendedActionSeverity: dashboardQuery.data?.workflowInbox.recommendedActionSeverity ?? null,
                recommendedActionPath: dashboardQuery.data?.workflowInbox.recommendedActionPath ?? null,
            }),
        [
            attentionNotifications,
            attestationGap,
            ...
            dashboardQuery.data?.workflowInbox.recommendedActionPath,
            dashboardQuery.data?.workflowInbox.recommendedActionSeverity,
